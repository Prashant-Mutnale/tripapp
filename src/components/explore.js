...
class Explore extends React.Component {
    constructor() {
        ...
        this.gettripsdetails=this.gettripsdetails.bind(this)
    }
    componentWillMount() {
        exploreResultArray = []
    ...
    gettripsdetails(keiddata){
        console.log("calledcomponent", keiddata)
        Actions.usertripsdetails({tripid:keiddata})
    }
    render() {
        ...
        <ScrollView >
            {
             ...
             <FlatList data = { this.state.exploredatalist }
            ...
            renderItem = {({ item }) =>
                ...
                onPress = {() => this.gettripsdetails(item.keyid) } >
                <View style = {{
                        flexDirection: 'row',
                        marginBottom: 10
                    }
                ...
                </View> <View style = {{ flex: 2, marginTop: 8, marginLeft: 10, alignItems: 'flex-start', justifyContent: 'flex-start' } } > <Text> { item.firstname } { item.lastname } </Text><TimeAgo time={item.keyid}/> </View>
                ...
                //  blurRadius={1}
                style = {
                    { borderRadius: 5, flexShrink: 1, flex: 1, width: null } }
                source = {
                    { uri: item.tripbackground } }
                /> <View style = {
                    {
                        flex: 3,
                ...
                <Text style = {
                    { color: '#fff', fontSize: 20 } } > { item.Triptitle } </Text> </View>
